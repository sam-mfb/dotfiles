...
"  autocmd CursorHold *.cs OmniSharpTypeLookup
  ...
  autocmd FileType cs nmap <silent> <buffer> <Leader>ty <Plug>(omnisharp_type_lookup)
  autocmd FileType cs nmap <silent> <buffer> <Leader>do <Plug>(omnisharp_documentation)
  ...
  autocmd FileType cs nmap <silent> <buffer> <Leader>for <Plug>(omnisharp_code_format)
